...
**Hitos mecánicos** (Haiku/mini): commit automático si `scripts/verificar-hito.sh` pasa.
**Hitos Estándar/Delicados**: proponer commit al Director y esperar aprobación explícita.
