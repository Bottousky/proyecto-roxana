...
export const ARITHMOS: ExperienceManifest = {
  ...
  status: 'playable',
  runtime: 'cosmos-web',
  rooms: ['landing', 'twins', 'balance', 'sails', 'gardens', 'flight'],
  learningVerb: 'transformar',
  fantasy: 'Cambiar las formas del mundo sin perder lo que las hace ser: devolver el viaje a un puerto detenido.',
  visualGrammar: {
    camera: 'diorama espacial con lente de planta y manipulación directa',
    style: 'cerámica, materia plegable, jardines de proporciones y un puerto sobre una ballena',
  },
};
