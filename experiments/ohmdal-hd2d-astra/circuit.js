...
export function initialState() {
  return { version: 1, started: false, inspected: false, talkedEdda: false, talkedLumen: false, hasStrap: false, returnRepaired: false, switchClosed: false, awakened: false, verified: false, crossed: false, player: [-6, 7] };
}
export function electricalState(state) {
  ...
  return { closed, current: closed ? sourceVoltage / loadResistance : 0, sourceVoltage, loadVoltage: closed ? sourceVoltage : 0, fault: !state.returnRepaired ? 'return-open' : !state.switchClosed ? 'switch-open' : null };
}
