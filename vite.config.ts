...
import { roxanaServicesPlugin } from './server/vite-plugin.mjs';
    ...
    },
    {
      ...
      generateBundle() {
        this.emitFile({
          type: 'asset',
          fileName: '_redirects',
          source: fs.readFileSync(resolve(__dirname, '_redirects'), 'utf8'),
        });
      },
    },
  ],
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        playcanvas: resolve(
          __dirname,
          'src/experiences/ohmdal-playcanvas/index.html',
        ),
      },
    },
  },
