...
Los archivos `plan-implementacion-*`, `spec-*`, `auditoria-*` y las entregas de cinemática son
registro de decisiones y criterios de regresión. No definen por sí solos la arquitectura futura.
Se conservan porque explican por qué el Arco I funciona como funciona.
