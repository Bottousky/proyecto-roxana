...
> [RECOVERY_AUDIT.md (histórico)](https://github.com/Bottousky/proyecto-roxana/blob/cdd4630/docs/20-worlds/ohmdal/room-based/RECOVERY_AUDIT.md), `ohmdal-arc-01_v1.md` (Cap 4 + Epílogo).
