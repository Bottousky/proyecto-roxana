...
equal(portalGateUrl().startsWith('/jugar?'), true, 'portalGateUrl contiene ruta jugar pública');
...
equal(portalExitUrl(), '/#sala/electronica', 'la salida abandona Phaser y vuelve al aula isométrica');
